     ...
     <Header/>
      ...
      <main className="relative">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          ...
                          <a
                            href="https://www.linkedin.com/feed/update/urn:li:activity:1234567890123456789/"
                            target="_blank"
        ...
        <section id="early-access" className="py-24 relative overflow-hidden">
          ...
          <div id="support" className="max-w-7xl mx-auto px-6">
            <AnimatedText>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://x.com/your-handle" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">X (Twitter)</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/your-username/SkillSync" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white text-sm transition-colors flex items-center gap-1">
