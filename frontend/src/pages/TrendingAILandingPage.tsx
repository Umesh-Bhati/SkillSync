                ...
                <AnimatedText delay={800}>
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span className="px-2 py-1 rounded-full bg-white/5 border border-white/10 text-xs">NodeJs</span>
                      <span className="px-2 py-1 rounded-full bg-white/5 border border-white/10 text-xs">NLP</span>
                      <span className="px-2 py-1 rounded-full bg-white/5 border border-white/10 text-xs">AI</span>
                      <span className="px-2 py-1 rounded-full bg-white/5 border border-white/10 text-xs">GenAI</span>
                    </div>
                  </div>
                </AnimatedText>
              </div>
                ...
                <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-indigo-500/30 transition-all duration-300">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Share your feedback directly on the LinkedIn post.
                          <br />
                          <a
                            href="https://www.linkedin.com/feed/update/urn:li:activity:7318568205667520512/"
                            target="_blank"
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-medium mb-2">Join Our Discord</h4>
                        <p className="text-gray-400">
                          Share ideas, report bugs, and chat with the SkillSync community.
                          <a href="https://discord.gg/FsTqxz8G"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-indigo-400 hover:text-indigo-300 transition-colors ml-1">
                            Join Here
            ...
            <AnimatedText>
              <div className="text-center mb-12">
                ...
                <div className="mt-10 flex justify-center">
                  <a href="https://www.buymeacoffee.com/0xumeshbhati"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-6 py-3 rounded-full bg-yellow-400 text-black font-semibold shadow-lg hover:scale-105 transition-all">
                    ☕ Buy Me a Coffee
                  </a>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <AnimatedText delay={200}>
              <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
                {['Google Cloud', 'Groq', 'OpenAI', 'Hugging Face'].map((logo, index) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://x.com/umeshbhatipro" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/app" className="text-gray-400 hover:text-white transition-colors">Try It Now</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://linkedin.com/in/umeshbhati" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">LinkedIn Updates</a></li>
                <li><a href="https://github.com/Umesh-Bhati/SkillSync" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">GitHub Repository</a></li>
                <li><a href="mailto:contact@example.com" className="text-gray-400 hover:text-white transition-colors">Contact</a></li>
                <li><a href="https://x.com/umeshbhatipro" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">X</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/Umesh-Bhati/SkillSync" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white text-sm transition-colors flex items-center gap-1">
